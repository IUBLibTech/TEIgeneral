...
<p>nextGroup: <xsl:value-of select="$nextGroup"/></p -->


<xsl:if test="$previous != ''">
<a href="{$base}{$previous}">
...
<xsl:text> </xsl:text>
 <xsl:choose>
	...
	<xsl:otherwise>
		<a href="{$base}{($page01 -1) * $pageSize + 1}"><xsl:value-of select="($group -1)*10+1 "/></a>
	</xsl:otherwise>
 </xsl:choose>
</xsl:if>
...
<xsl:text> </xsl:text>
 <xsl:choose>
	...
	<xsl:otherwise>
		<a href="{$base}{($page02 -1 ) * $pageSize + 1}"><xsl:value-of select="($group -1)*10+2 "/></a>
	</xsl:otherwise>
 </xsl:choose>
</xsl:if>
...
<xsl:text> </xsl:text>
 <xsl:choose>
	...
	<xsl:otherwise>
		<a href="{$base}{($page03 -1 ) * $pageSize + 1}"><xsl:value-of select="($group -1)*10+3 "/></a>
	</xsl:otherwise>
 </xsl:choose>
</xsl:if>
...
<xsl:text> </xsl:text>
 <xsl:choose>
	...
	<xsl:otherwise>
		<a href="{$base}{($page04 -1 ) * $pageSize + 1}"><xsl:value-of select="($group -1)*10+4 "/></a>
	</xsl:otherwise>
 </xsl:choose>
</xsl:if>
...
<xsl:text> </xsl:text>
 <xsl:choose>
	...
	<xsl:otherwise>
		<a href="{$base}{($page05 -1 ) * $pageSize + 1}"><xsl:value-of select="($group -1)*10+5 "/></a>
	</xsl:otherwise>
 </xsl:choose>
</xsl:if>
...
<xsl:text> </xsl:text>
 <xsl:choose>
	...
	<xsl:otherwise>
		<a href="{$base}{($page06 -1 ) * $pageSize + 1}"><xsl:value-of select="($group -1)*10+6 "/></a>
	</xsl:otherwise>
 </xsl:choose>
</xsl:if>
...
<xsl:text> </xsl:text>
 <xsl:choose>
	...
	<xsl:otherwise>
		<a href="{$base}{($page07 -1 ) * $pageSize + 1}"><xsl:value-of select="($group -1)*10+7 "/></a>
	</xsl:otherwise>
 </xsl:choose>
</xsl:if>
...
<xsl:text> </xsl:text>
 <xsl:choose>
	...
	<xsl:otherwise>
		<a href="{$base}{($page08 -1 ) * $pageSize + 1}"><xsl:value-of select="($group -1)*10+8 "/></a>
	</xsl:otherwise>
 </xsl:choose>
</xsl:if>
...
<xsl:text> </xsl:text>
 <xsl:choose>
	...
	<xsl:otherwise>
		<a href="{$base}{($page09 -1 ) * $pageSize + 1}"><xsl:value-of select="($group -1)*10+9 "/></a>
	</xsl:otherwise>
 </xsl:choose>
</xsl:if>
...
<xsl:text> </xsl:text>
 <xsl:choose>
	...
	<xsl:otherwise>
		<a href="{$base}{$page10 * $pageSize + 1}"><xsl:value-of select="($group -1)*10+10 "/></a>
	</xsl:otherwise>
 </xsl:choose>
</xsl:if>
...
<xsl:text> </xsl:text>
 <a href="{$base}{$nextGroup}">&gt;&gt;</a> 
</xsl:if>

<xsl:if test="$next != ''">
<xsl:text> </xsl:text>
<a href="{$base}{$next}">
<img src="http://www.oac.cdlib.org/images/next.gif" width="72" height="22" border="0" alt="next &gt;&gt;" class="prevNextButton" align="middle"/></a>
</xsl:if>
